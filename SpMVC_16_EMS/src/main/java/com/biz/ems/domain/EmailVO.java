...
public class EmailVO {
	...
	@Column(name="ems_seq")
	private long emsSeq;  // EmailDao의 findBySeq는 VO에 있는 변수명과 일치해야해서 camel case를 사용하고 name을 따로 설정해줌
	...
	private String fromEmail;  // 보내는 email
	...
	private String fromName;	// 보낸사람 이름
