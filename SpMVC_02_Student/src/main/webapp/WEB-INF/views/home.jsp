...
/*
	...
	==> 기존변수(변수명이 매우 길어서 불편할 경우)를
	새로운 벼수에 임시 할당하여
	jsp코드 내에서 자유롭게 사용하는 방법
	
	pageContext : jsp에 설정된 전역 객체, 여러가지 정보를 담고 있음
	request : web에서 전송된 여러가지 정보가 담긴 sub class(객체)
	contextPath : project의 context문자열을 담고 있는 필드변수
...
<!--  a tag : anchor : 링크설정, 문자열을 클릭하면 다른 페이지로 점프 -->
<p>
