...
@Configuration
@MapperScan("com.biz.rbooks.repository")  // == MyBatis Spring scan
...
public class MybatisConfig {
	...
	public DataSource oracleDs() {
		...
		ds.setUsername("books");
		ds.setPassword("books");
	...
	public DataSourceTransactionManager tm() {
		DataSourceTransactionManager tm = 
				new DataSourceTransactionManager(oracleDs()); // constructor arguments
