...
public class DeptController {
	...
	// /dept와 /lis를 묶어서 /dept/list path로 request를 했을 때
	// list() method가 호출된다.
	@RequestMapping(value = "/list", method = RequestMethod.GET)
	public ModelAndView list() {
		
		/*
		 * Model(ui.Mo0del) 클래스와 같은 역할을 수행하는 Spring 클래스
		 * 사용법이 조금 다른 형식
		...
		// return String이 아닌 ModelAndView사용
		return mView;
	...
	/*
	 * 입력 폼에서 데이터를 입력하고
	 * 전송(저장) 버튼을 클릭하면 데이터를 가지고 호출될 method
	 */
