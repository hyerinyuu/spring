...
public class PetService {
	...
	public List<GoPetVO> getRestVoList(String s_cat, String s_text){
		...
		// spring 3.2에서 도입된 새로운 HttpConnetion 추상화된객체
...
//		log.debug("xml or json <?xml>, {json}" + result.toString());
//		String restString = result.getBody().toString();
//		return restString;
//		
	}
...
//			log.debug("***************List테스트(service) : " + petList.toString());
//			
...
//
//			// exception이 발생했을 때는 1개짜리 list를 만들어서 return
