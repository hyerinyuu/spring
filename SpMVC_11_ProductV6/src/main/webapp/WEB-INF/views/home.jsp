...
<link rel="stylesheet" href="${rootPath}/css/pro-main.css?ver=2019-12-23-002">
<script>
...
<body>
	...
	<section class="container-fluid">
		<article class="row d-flex justify-content-center">
			<div id="p_list" class="col-lg-4 col-md-5"><%@ include
					file="/WEB-INF/views/plist.jsp"%></div>
			...
			<section class="col-lg-4 col-md-5 col-sm-11">
				<form class="was-validated" method="POST"
					...
					<div class="form-group main-img-box">
						<img src="${rootPath}/files/noimage.png" id="p_image" width="30%">
						<div class="img-menu">
	...
	<footer class="container-fluid bg-light">
		<address class="text-center text-black">Copy Right &copy;
			hyerin.you@gmail.com</address>
	</footer>
