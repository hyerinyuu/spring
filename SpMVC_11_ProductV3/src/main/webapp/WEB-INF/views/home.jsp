...
<body>
	...
	<section class="container-fluid">
		<article class="row d-flex justify-content-center">
			<div id="p_list" class="col-lg-4 col-md-5"><%@ include file="/WEB-INF/views/p-list.jsp" %></div>
			...
			<section class="col-lg-4 col-md-5 col-sm-11">
				<form class="was-validated" 
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" placeholder="상품코드를 입력하세요" id="p_code" name="p_code">
				  </div>
				  
				  <div class="form-group">
				    <label for="p_name">상품이름</label>
				    <input type="text" class="form-control" placeholder="상품이름을 입력하세요" id="p_name" name="p_name" required>
				   ...
				   <div class="form-group">
				    ...
				    <input type="text" class="form-control" placeholder="매입가격을 입력하세요" id="p_iprice" name="p_iprice" required>
				    <div class="valid-feedback">Valid.</div>
				  ...
				  <div class="form-group form-check">
				   ...
				   <div class="form-group">
				    ...
				    <input type="text" class="form-control" placeholder="매출가격을 입력하세요" id="p_oprice" name="p_oprice" required>
				    <div class="valid-feedback">Valid.</div>
				  ...
				  <%
				  	...
				  	-multiple="multiple" 
				  	 ...
				  	 -accept=""
				  	 : 특정한 성질의 파일만 올리고 싶을때
				  	 (ex: accept="image/*" => 이미지 관련 파일만
				  	      accept="text/plain" => txt 파일만(*.txt)
				  	      accept="text/html" => text파일 중에 *.html만
				  	      accept="video/*" => 동영상관련 파일만
				  	      accept="application/vnd.ms-excel" => excel 파일만
				  	      accept=".xls|xlsx" : excel파일 호환성때문에 이 방법을 더 많이 사용)
				  	*/
				  %>
				   <div class="form-group">
				   	<input type="hidden" name="p_file" id="p_file">
					<label></label>
					<input type="file" class="form-controller" name="u_files" id="u_file"  multiple="multiple" accept="image/*">	
				  </div>
				  ...
				  <button type="submit" class="btn btn-outline-primary btn-block">저장</button>
				  
				</form>			
			</section>
		
		<div id="p_sub_list" class="col-lg-3 col-md-5">보조정보</div>
	...
	<footer class="container-fluid bg-light">
		<address class="text-center text-black">Copy Right &copy; hyerin.you@gmail.com</address>
	</footer>
