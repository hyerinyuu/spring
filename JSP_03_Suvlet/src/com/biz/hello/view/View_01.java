 ...
 * 
 * /view/01 : URI, javaWeb에서는 path라고 한다.
...
public class View_01 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 *  현재 서버의 상태가 어떠한지
		 *  숫자값으로 전송해서 네트워크의 성능을 높이는 용도로 사용한다.
		 *  
		 *  2xx : 정상데이터를 추출중이니 기다려라
		 *  3xx : 이전 상태와 유사, 동일하니 너에게 줄것이 없다.
		 *  4xx : 요청사항이 잘못 전달 되었다.
		 *  	400 : query데이터를 request.getParameter()로 받았는데 문제가 있음 
		 *  	404 : Not Found
		 *  5xx : server APP이 작동되는 과정에서 Exception이 발생했다.
		 * 
		 */
