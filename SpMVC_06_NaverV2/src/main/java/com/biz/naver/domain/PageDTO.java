 ...
 * 설정값을 변경하여 쉽게 페이지리스트를 그릴 수 있는 정보를 저장할 칼럼
 * 
 * 전체 데이터 개수 : 페이지수등을 계산
 * 현재페이지에 보여질 리스트 개수
 * 현재페이지 하단에 보여질 페이지 개수
 * 
 * 보여지는 페이지의 끝번호 : 계산후
 * 보여지는 페이지의 끝번호 : 계산후
 * 
 * 처음페이지 : "처음"을 클릭했을때 보여질 페이지 번호(1페이지)
 * 마지막페이지 : "끝"을 클릭했을때 전체 데이터 개수등으로 계산
 * 
 * 이전페이지
 * 이후페이지
 */
...
public class PageDTO {
	...
	private long finalPageNo; // 전체 데이터의 마지막 페이지 번호(계산결과)
	...
	long currentPageNo;  // 현재 선택된 페이지 번호
