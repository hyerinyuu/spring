...
<form:form modelAttribute="imageVO">
	<fieldset>
		...
		<div class="input_box">
			<form:textarea path="img_text" placeholder="내용을 입력하세요" />
		</div>
			...
			<div class="input_box">
				<div class="img_list">
					<c:forEach items="${imageVO.img_files}" var="img">
						<div class="img_view" data-id="${img.img_file_seq}" data-pcode="${imageVO.img_seq}">
		...
		<div class="input_box">
			...
			<button class="bz-button" id="btn_list" type="button"><a href="${rootPath}/">리스트보기</a></button>
