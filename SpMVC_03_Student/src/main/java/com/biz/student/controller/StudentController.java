...
public class StudentController {
	...
	/*
	 * Container에 등록된 bean에서 StudentService 클래스의 객체를 가져와서
	 ...
	 * sprign, tomcat, dispatcher등에게 요청하는 것
	 */
	@RequestMapping(value="/student/list", method=RequestMethod.GET)
	public String list(Model model){
		/*
		 * Model : dispatcher에게 *.jsp파일에 데이터를 보내서 Rendering을 할텐데
		...
		/*
		 * StudentService의 getList()를 호출해서
